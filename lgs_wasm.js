/* @ts-self-types="./lgs_wasm.d.ts" */

export class PreviewEngine {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        PreviewEngineFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_previewengine_free(ptr, 0);
    }
    /**
    ...
    authenticate() {
        try {
            ...
            wasm.previewengine_authenticate(retptr, this.__wbg_ptr);
    ...
    balance() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.previewengine_balance(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    endRound() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.previewengine_endRound(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    listModes() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.previewengine_listModes(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
     ...
     */
    loadConfig() {
        const ret = wasm.previewengine_loadConfig(this.__wbg_ptr);
    ...
    loadManifest(url) {
        ...
        const ret = wasm.previewengine_loadManifest(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
     ...
     */
    loadMode(mode_name) {
        const ptr0 = passStringToWasm0(mode_name, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.previewengine_loadMode(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
     ...
     */
    constructor(game, base_url) {
        const ptr0 = passStringToWasm0(game, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(base_url, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.previewengine_new(ptr0, len0, ptr1, len1);
        this.__wbg_ptr = ret >>> 0;
        PreviewEngineFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    play(mode, amount) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.previewengine_play(retptr, this.__wbg_ptr, ptr0, len0, amount);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
...
if (Symbol.dispose) PreviewEngine.prototype[Symbol.dispose] = PreviewEngine.prototype.free;
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_323f37fd55ab048d: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return __wasm_bindgen_func_elem_2063(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_2061);
            return addHeapObject(ret);
        },
    ...
    return {
        __proto__: null,
        "./lgs_wasm_bg.js": import0,
    };
}

function __wasm_bindgen_func_elem_2061(arg0, arg1, arg2) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.__wasm_bindgen_func_elem_2061(retptr, arg0, arg1, addHeapObject(arg2));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
...
const PreviewEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_previewengine_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('lgs_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
